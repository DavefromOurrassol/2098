...
**Sujet de qualité ouvert, distinct du bug ci-dessus** — le taux de
70,4% (Cas A) reste un vrai signal : le LLM ne respecte pas fiablement
la consigne de longueur donnée dans `build_journalistic_brief()`, sans
biais directionnel net (certains articles dépassent largement la plage,
d'autres sont largement en dessous). Voir `BACKLOG_MASTER_9_AOUT.md`,
Partie 1 point 1 — à investiguer.
