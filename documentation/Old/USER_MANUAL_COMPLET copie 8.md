...
*Consolidé le 15 juillet 2026, mis à jour le 3 août 2026, 9 août 2026, 10 août 2026, 11 août 2026 (deux fois : clarté des descriptifs le matin, bugs réels + clôture du test navigateur GUI le soir), et 12 août 2026 — couvre `generator/` (39+ scripts Python) et `gui/` (Flask)*
