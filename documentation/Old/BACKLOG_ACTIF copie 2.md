...
`USER_MANUAL_COMPLET.md`. Seul point restant, pas une tâche : observer
le risque de formulation temporelle relative incohérente sur plus de
volume avant d'envisager un correctif (cohérent avec P17/Bug#27).*
