...
## ✅ 17. Variété de palette/éclairage + réutilisation des signes distinctifs dans `image_prompt` — codé (23 août), pas encore re-testé en conditions réelles
...
**Fichier livré** : `prompt_builder.py` (cumulé avec le correctif P25
ci-dessus — un seul remplacement suffit).
