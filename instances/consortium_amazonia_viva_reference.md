...
role_dans_scenario: >
  Dans un monde en équilibre fragile, le Consortium Amazônia Viva s'est imposé comme l'acteur central de la gouvernance écologique du bassin amazonien, jouant sur la légitimité des gardiens du territoire pour négocier directement avec les blocs géopolitiques concurrents. Son existence même représente une expérience inédite de diplomatie infra-étatique : en réunissant 94 peuples autochtones, des cohortes de scientifiques et plusieurs administrations locales brésiliennes, colombiennes, péruviennes et boliviennes, il revendique une souveraineté fonctionnelle sur un espace que les États-nations n'arrivent plus à gérer seuls. Sa force tient à ce qu'aucun acteur extérieur ne peut légitimement nier son rôle sans se condamner publiquement face à l'opinion mondiale, dans un contexte où la biodiversité amazonienne est devenue une variable explicite de la stabilité climatique globale.

responsabilites: >
  Le Consortium négocie des accords de préservation et d'exploitation contrôlée des ressources biologiques et hydriques du bassin avec les blocs eurasiatique, pacifique et nord-atlantique, tout en assurant une surveillance scientifique continue des écosystèmes via un réseau de capteurs partagés. Il administre un système de compensation carbone et de valorisation de la biodiversité qui redistribue des flux financiers vers les communautés autochtones membres. Il assume également une fonction de veille et d'alerte face aux incursions illégales des consortiums extractifs.
...
signes_distinctifs: >
  Le logo du Consortium représente un jaguar composé de filaments d'ADN végétal sur fond de carte topographique amazonienne ; ses membres portent souvent un bracelet tressé de fibres végétales certifiées comme signe d'appartenance communautaire. Ses communications officielles sont toujours trilingues — portugais, espagnol, et une langue autochtone rotative choisie par les peuples membres pour l'année en cours.
