---
name: Confédération des Archipels Flottants du Pacifique Sud (CAFPS)
type: instance
...
role_dans_scenario: >
  Confédération de communautés installées sur des archipels artificiels flottants dans le Pacifique Sud, construits en réponse à la montée des eaux. Cette organisation gère la souveraineté partagée de territoires mobiles et négocie avec les États côtiers et les corporations maritimes l'accès aux ressources halieutiques et énergétiques. Elle constitue un laboratoire vivant de gouvernance sans sol fixe, inventant des protocoles délibératifs adaptés à des populations dont l'espace d'existence est lui-même en mouvement. Dans l'équilibre fragile du monde de 2098, elle occupe une position charnière : trop organisée pour être ignorée, trop vulnérable pour imposer ses conditions.

responsabilites: >
  La CAFPS coordonne la gestion collective des plateformes flottantes — maintenance structurelle, allocation des espaces habitables, régulation des flux migratoires internes — et négocie les accords d'accès aux zones économiques exclusives des États côtiers pour la pêche et l'exploitation des énergies marines. Elle administre également un système de représentation tournante entre les communautés membres et maintient un registre de souveraineté mobile reconnu par un nombre limité d'instances internationales.
...
signes_distinctifs: >
  Les plateformes arborent un drapeau bleu-vert frappé d'un hexagone blanc — symbole des cellules modulaires qui composent leurs territoires — et chaque embarcation officielle porte une balise de géolocalisation publique inscrite dans le registre open-source de la CAFPS. Les délégués portent traditionnellement un cordon tressé de fibres recyclées dont la couleur indique la communauté d'origine.
