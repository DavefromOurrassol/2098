---
name: Friches Corridors — Terres de Passage
type: instance
...
role_dans_scenario: "Les Friches Corridors sont d'anciens territoires d'extraction minière et énergétique — carrières, puits, zones de stockage de résidus — progressivement reconvertis en corridors de transit écologique par des coalitions communautaires. Dans le monde éco-communaliste de 2098, ils constituent les veines du réseau de circuits courts : ni tout à fait sauvages, ni encore pleinement communs, ils sont le lieu physique où s'expérimente la reconversion d'un sol épuisé en lien vivant entre communautés autonomes. Leur statut reste disputé entre les réseaux communalistes qui les revendiquent comme biens communs et les anciennes multinationales qui y détiennent encore des titres fonciers non annulés, faisant de chaque arpent de friche reconvertie un terrain de négociation ou de conflit latent."
responsabilites: |
  Assurer la continuité physique et écologique entre communautés autonomes via des couloirs de transit pour les semences, les personnes et la faune. Héberger les chantiers de dépollution et de restauration portés par les brigades communautaires. Servir de terrain d'application aux jurisprudences communales émergentes sur le statut des terres post-extractives.
impact_local: 5
...
signes_distinctifs: Bornes orange rouillées des anciens périmètres miniers retournées et replantées comme tuteurs pour les arbustes pionniers ; panneaux bilingues en langue communautaire locale et en signes cartographiques partagés indiquant les droits de passage et les zones de restauration active ; traces de piste d'extraction transformées en sentiers balisés par des cairns de schiste.
tensions_narratives: |
