---
name: Alliance pour la Souveraineté Maritime des Peuples Insulaires (ASMPI)
type: instance
...
role_dans_scenario: >
  L'ASMPI fédère les États-archipels et communautés insulaires du Pacifique Sud dont les territoires terrestres sont partiellement ou totalement submergés, leur offrant un cadre juridique post-territorial innovant fondé sur des zones économiques exclusives mobiles et des droits souverains attachés à la population plutôt qu'au sol. Dans un monde de multipolarité instable, elle occupe une niche diplomatique unique : celle de la légitimité morale inattaquable face aux grandes puissances. Elle incarne une forme d'agentivité collective nouvelle, transformant la vulnérabilité climatique en levier politique dans les arènes de négociation globale sur la redistribution des ressources critiques et la dette climatique.

responsabilites: >
  L'ASMPI négocie des accords de souveraineté mobile avec les institutions multilatérales survivantes, maintient des registres numériques distribués de citoyenneté, de patrimoine culturel et de droits fonciers pour les populations déplacées, et coordonne les flottes résidentielles et plateformes flottantes constituant l'habitat de ses membres. Elle porte également la revendication d'une compensation climatique structurelle auprès des blocs économiques dominants.
...
signes_distinctifs: >
  Le logo de l'ASMPI représente une île stylisée dont le contour se dissout dans une vague mais dont le cœur — symbolisé par une flamme — reste intact et flottant. Les représentants portent systématiquement une bande textile aux couleurs de leur île d'origine, souvent submergée, tissée selon des techniques traditionnelles préservées dans les archives numériques du réseau Mnemos. Leurs documents officiels sont datés selon un double calendrier : l'année grégorienne standard et l'année de la 'Continuité', comptée depuis la première submersion permanente de 2039.
