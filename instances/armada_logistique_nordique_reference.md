---
name: Armada Logistique Nordique
type: instance
...
role_dans_scenario: >
  Opérateur para-étatique dominant des corridors arctiques déglaciés, l'ALN s'est imposée comme un acteur systémique indispensable dans un monde de blocs concurrents et de ruptures logistiques chroniques. Elle administre les routes de transit entre l'Europe, l'Asie et l'Amérique du Nord avec une autorité quasi-souveraine, négociant ses accès de passage comme une monnaie géopolitique. Dans un scénario de fragile équilibre, son rôle de 'stabilisateur passif' lui confère un pouvoir de nuisance considérable : elle ne rompt pas l'ordre, elle en fixe le prix.

responsabilites: >
  Gestion opérationnelle des routes maritimes arctiques et des hubs de transbordement polaires (Svalbard Logistics Hub, Mourmansk Terminal Ouest). Négociation bilatérale des droits de transit avec les blocs géopolitiques concurrents — UE, Sibérie Fédérale, Confédération Pacifique. Maintenance et sécurisation des infrastructures énergétiques sous-marines longeant les couloirs nordiques.
...
signes_distinctifs: >
  Triple anneau entrelacé bleu glaciaire, blanc arctique et argent métallique — logo omnipresent sur les flancs des brise-glaces autonomes et les terminaux portuaires. Architecture des hubs marquée par des structures modulaires semi-enterrées conçues pour le pergélisol résiduel. Uniforme opérationnel gris-ardoise à col haut, emblème thermochromique changeant de couleur selon la température extérieure.
