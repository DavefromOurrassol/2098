---
name: Chambre de Recours Algorithmique — Bruxelles Résiduelle
type: instance
...
signes_distinctifs: >
  Le sceau de la Chambre représente une balance dont l'un des plateaux est occupé par un nœud de réseau stylisé — symbole de l'équilibre impossible entre droit humain et logique machine. Les audiences se tiennent dans un silence inhabituellement formel pour une institution aussi marginalisée : les juristes-auditeurs portent encore la robe noire à col blanc, comme une affirmation rituelle de continuité institutionnelle face à l'effacement. Les dossiers physiques — papier, tamponnés, reliés — sont délibérément maintenus comme preuve d'existence non falsifiable.
