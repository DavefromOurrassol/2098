---
name: Mouvement Commun Midwest — Front du Dehors
type: instance
...
role_dans_scenario: >
  Mouvement de résistance populaire né en réaction aux politiques d'exclusion des forteresses climatiques du Midwest nord-américain, défendant le droit d'accès aux zones protégées pour les populations laissées à l'extérieur des murs. Il organise des actions de pression politique, des filières d'entraide clandestines et des campagnes de visibilité médiatique pour dénoncer la ségrégation climatique institutionnalisée. Ses membres sont régulièrement fichés et surveillés par les autorités des enclaves. Dans un monde où l'archipel territorial s'est figé en blocs hermétiques, le Front du Dehors incarne la seule voix organique des millions d'exclus des zones protégées, naviguant entre légalité précaire et clandestinité structurelle pour maintenir la pression sur les gouvernances forteresses.

responsabilites: >
  Coordination de filières d'entraide clandestines permettant l'accès aux ressources médicales, hydriques et alimentaires des enclaves pour les populations périphériques ; organisation de campagnes de documentation et de diffusion sur les conditions de vie aux seuils des murs via des réseaux d'information souterrains ; représentation politique résiduelle auprès des institutions multilatérales encore accessibles et dépôt de recours juridiques contre les administrations de contrôle frontalier.
...
signes_distinctifs: >
  Brassards cousus main en tissu orange délavé, couleur des alertes climatiques jamais levées dans les zones périphériques ; graffitis en forme de demi-cercle barré d'une ligne horizontale — le symbole d'un seuil infranchissable retourné en revendication ; communications signées d'un simple pictogramme de main ouverte tournée vers un mur.
