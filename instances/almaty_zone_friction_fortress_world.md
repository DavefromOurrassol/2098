---
name: Zone de Friction d'Almaty — Périmètre des Seuils Kazakhs
type: instance
...
role_dans_scenario: >
  Zone tampon surveillée aux abords d'Almaty, marquant la frontière entre l'enclave climatisée des élites et les quartiers périphériques non protégés. Ce territoire de friction concentre les checkpoints biométriques, les tensions sociales et les flux migratoires bloqués par les murs de la forteresse kazakhe. Il est le théâtre permanent de négociations clandestines et d'incidents sécuritaires. Ni intégrée à la forteresse d'Almaty ni abandonnée à la steppe périphérique, la Zone de Friction est maintenue délibérément dans un état d'ambiguïté juridique et fonctionnelle : soupape indispensable pour l'enclave, elle absorbe la pression des flux migratoires bloqués tout en alimentant les économies grises dont les élites de l'intérieur bénéficient tacitement. Sa suppression déstabiliserait l'enclave ; sa formalisation la viderait de sa fonction.

responsabilites: >
  Filtrage et tri biométrique des corps en transit aux checkpoints périmétraux, maintien d'un état de contrôle diffus combinant surveillance algorithmique et milices privées sous-traitées. La zone gère de facto les flux de population refoulée, les négociations clandestines entre opérateurs de contrebande et agents de l'enclave, ainsi que la containment des incidents sécuritaires récurrents avant qu'ils n'atteignent les murs intérieurs.
...
signes_distinctifs: >
  Rangées de portiques biométriques à lumière orange pulsée alignés à intervalles réguliers sur la ligne de démarcation, visibles à plusieurs kilomètres dans la plaine kazakhe. Murs couverts de marquages de transit effacés et réécrits par couches successives — langues kirghize, russe, mandarin, dari —, témoins stratifiés de vagues migratoires successives. L'air y est chargé de poussière thermique et du bourdonnement permanent des drones de patrouille à basse altitude.
