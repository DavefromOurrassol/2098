---
name: Chambre des Recours Algorithmiques — Ce qu'il en reste
type: instance
...
signes_distinctifs: >
  Le sceau de la Chambre représente une balance dont l'un des plateaux porte un circuit imprimé fracturé — héritage du logo original du Tribunal bruxellois, redessiné à la main après la perte des fichiers vectoriels officiels. Les membres portent des manchettes grises cousues sur leurs vêtements de terrain, seul insigne de fonction encore toléré. Les audiences s'ouvrent toujours par la lecture d'un article du Règlement Européen sur l'IA de 2026 — récité de mémoire, comme un psaume.
