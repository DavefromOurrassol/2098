---
name: Forum Léman — Coordination pour le Recul des Eaux
type: instance
...
role_dans_scenario: >
  Organisation de gestion environnementale et patrimoniale fondée autour de la retraite progressive des eaux du lac Léman, devenu symbole des mutations climatiques non résolues. Dans un monde fragmenté, elle coordonne des projets d'adaptation territoriale entre acteurs locaux aux intérêts divergents — cantons suisses, collectivités françaises riveraines, opérateurs touristiques, lobbies agricoles, ONG environnementales — sans parvenir à imposer une vision cohérente. Elle sert de forum neutre pour des négociations souvent bloquées par les tensions géopolitiques persistantes entre blocs continentaux. Sa survie tient précisément à son impuissance constitutive : aucun acteur ne veut porter la responsabilité de sa dissolution, mais aucun ne consent à lui céder un pouvoir réel d'arbitrage ou d'injonction.

responsabilites: >
  Produit des rapports cartographiques semestriels sur le recul du trait de rive du Léman, finance des études d'adaptation pour les communes exposées, et organise des sessions de négociation multipartites entre gouvernements locaux, opérateurs économiques et représentants de la société civile. Gère un fonds commun d'indemnisation patrimoniale pour les infrastructures submergées ou abandonnées en zone de retrait, alimenté par contributions volontaires.
...
signes_distinctifs: >
  Logo représentant un liseré bleu en pointillés — la ligne de rive historique de 2000 superposée à la ligne actuelle, visible en retrait — imprimé sur tous les documents officiels. Les sessions plénières se tiennent systématiquement dans des bâtiments riverains du lac, dont certains présentent désormais des marques de niveau d'eau fossilisées sur leurs façades, conservées délibérément comme mémorial visible.
