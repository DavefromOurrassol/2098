...
role_dans_scenario: >
  Philosophe-praticienne de la gouvernance des communs, Leena Väinälä est devenue l'une des architectes les plus influentes des chartes constitutives des confédérations locales post-effondrement. Dans un monde fragmenté en unités autonomes souvent en tension entre tradition communautaire et pragmatisme de survie, elle circule entre les réseaux régionaux scandinaves, baltiques et nord-européens comme une figure médiatrice et fondatrice. Son œuvre théorique sur la démocratie délibérative à échelle humaine est devenue un texte de référence opérationnel, repris, adapté, parfois dévoyé, dans des dizaines de chartes locales. Elle incarne la résistance à la tentation technocratique qui menace ces communautés fragiles.

responsabilites: >
  Elle rédige et négocie des protocoles de gouvernance participative pour les assemblées de bassin et les conseils de communs numériques régionaux. Elle forme des facilitateurs délibératifs dans les réseaux de l'Arc septentrional et intervient comme médiatrice lors des crises de légitimité institutionnelle entre communes. Elle maintient une archive ouverte et décentralisée de jurisprudence des communs, accessible via les réseaux mesh locaux.
...
signes_distinctifs: >
  Carnet de terrain relié en cuir recyclé couverts d'annotations multilingues, présence physique systématiquement sobre et dépourvue de projection technologique lors des assemblées. Sa signature visuelle informelle est un triptyque de cercles entrelacés — symbole devenu iconique des chartes qu'elle a rédigées — repris sur des affiches, des murs et des tokens de gouvernance locaux.
