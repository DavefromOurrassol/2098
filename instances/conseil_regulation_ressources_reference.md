---
name: Conseil de Régulation des Ressources Critiques
type: instance
...
role_dans_scenario: >
  Organe supranational issu des accords de Nairobi 2061, le CRRC survit en 2098 comme arbitre imparfait mais indispensable des flux de ressources stratégiques — lithium, eau dessalée, hydrogène vert, terres rares. Dans un monde multipolaire fracturé, il joue un rôle de chambre de compensation plutôt que de véritable régulateur : les grandes puissances l'utilisent quand cela les arrange et le contournent quand leurs intérêts divergent. Son existence maintient une fiction de coopération globale sans laquelle les tensions iraient plus vite vers l'ouvert conflit.

responsabilites: >
  Fixe des quotas d'extraction et des couloirs de transit reconnus par les 74 États signataires ; arbitre les litiges entre blocs énergétiques concurrents via des procédures de médiation longues et souvent contestées ; publie les Indices de Stress Ressources (ISR) trimestriels qui font référence sur les marchés mais sont régulièrement accusés de manipulation politique.
...
signes_distinctifs: >
  Logo en forme de nœud gordien stylisé entourant un globe fragmenté — initialement symbole d'unité, aujourd'hui perçu comme métaphore involontaire de l'impasse. Ses documents officiels portent toujours l'en-tête trilingue swahili-anglais-mandarin des accords fondateurs, une survivance protocolaire que personne n'ose abandonner.
