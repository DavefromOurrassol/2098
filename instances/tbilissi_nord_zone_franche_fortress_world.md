---
name: Tbilissi Nord Zone Franche — Forteresse Thermique du Caucase
type: instance
...
role_dans_scenario: >
  Enclave urbaine fortifiée au nord de Tbilissi, la Zone Franche s'est transformée en territoire-forteresse géré par un consortium privé de sécurité climatique. Elle abrite les élites caucasiennes et les expatriés fortunés derrière des murs thermiques et des systèmes de surveillance biométrique, tandis que les zones périphériques sont laissées à la dégradation environnementale. En 2098, elle constitue le modèle régional le plus avancé de privatisation de la souveraineté : le consortium gestionnaire y lève ses propres taxes d'accès, délivre ses propres accréditations biométriques et négocie directement avec les blocs géopolitiques sans passer par l'État géorgien fantoche. Sa seule logique est celle du marché de la survie climatique : tenir les standards intérieurs, absorber les ressources du dehors, et vendre l'accès au prix du désespoir.

responsabilites: >
  Le consortium gestionnaire assure le contrôle thermique de l'enceinte, la sécurité biométrique des points d'accès, la fourniture énergétique autonome et la gestion des accréditations résidentielles et professionnelles. Il négocie les contrats de transit logistique avec les opérateurs caucasiens et centrasiatiques, supervise l'extraction des ressources humaines qualifiées des zones périphériques via un système de visas de travail temporaires non renouvelables, et administre ses propres juridictions contractuelles pour les litiges internes.
...
signes_distinctifs: >
  L'enceinte est identifiable à ses panneaux miroirs inclinés à 15 degrés qui renvoient la chaleur vers l'extérieur — effet délibérément visible depuis les quartiers périphériques. Les accréditations biométriques se portent sous forme de patch cutané luminescent dont la couleur varie selon le niveau d'accès : blanc pour les résidents permanents, amber pour les prestataires, rouge clignotant pour les laissez-passer expirés. Le logo de CaucaSec Thermal Holdings — un hexagone blanc sur fond anthracite — orne tous les murs intérieurs mais est rigoureusement absent des façades externes.
