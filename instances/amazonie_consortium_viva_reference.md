...
role_dans_scenario: >
  Consortium privé opérant dans le bassin amazonien, exploitant les zones grises juridiques pour extraire et breveter des ressources génétiques forestières. Dans le scénario de référence — où la gouvernance internationale est partiellement fonctionnelle mais fragmentée et lente — le Consortium Viva prospère précisément dans les interstices entre juridictions nationales amazoniennes (Brésil, Pérou, Colombie, Bolivie) et les cadres multilatéraux incomplets sur la biodiversité. Il transforme en capital brevetable des séquences génomiques forestières, des composés bioactifs et des variétés endémiques avant que les régulateurs n'aient pu en établir la souveraineté collective. Sa vitesse d'action juridico-technique constitue son avantage comparatif décisif dans un monde où la réglementation avance à pas institutionnels tandis que la biotechnologie progresse par bonds.

responsabilites: >
  Prospection génomique à haute cadence dans des zones forestières sous-documentées, dépôt systématique de brevets dans des juridictions à faible protection bioculturelle (Singapour, Panama, certains États du Golfe). Mobilisation d'équipes juridiques spécialisées pour contester toute tentative d'annulation de brevets, et monétisation des licences auprès de laboratoires pharmaceutiques, agrochimiques et de nutrition fonctionnelle à l'échelle globale.
...
signes_distinctifs: >
  Logo en forme de spirale d'ADN fusionnée avec une fronde végétale dorée sur fond vert sombre — omniprésent sur les campements de terrain hermétiquement fermés et sur les dépôts de brevets. Uniformes de terrain couleur canopée avec badge numérique de traçabilité génomique. Discours publics construits autour du lexique de la 'valorisation' et de la 'découverte responsable', contrastant radicalement avec les témoignages des communautés riveraines.
