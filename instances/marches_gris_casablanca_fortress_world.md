---
name: Marchés Gris de Casablanca — Bureau des Interstices Atlantiques
type: instance
...
role_dans_scenario: >
  Les Marchés Gris de Casablanca opèrent dans les zones tampons entre les enclaves fortifiées du Pacte Atlantique et les territoires exclus de la métropole atlantique, exploitant systématiquement les asymétries réglementaires entre secteurs surveillés et zones grises. Ni organisation criminelle déclarée ni acteur légitime, le Bureau des Interstices Atlantiques est toléré par les autorités de la forteresse parce qu'il remplit des fonctions vitales que celles-ci ne peuvent assumer officiellement : distribution de biens de contrebande calibrée, circulation de données biométriques monnayables, fabrication et revente de laissez-passer falsifiés permettant les mobilités que le système interdit en théorie mais nécessite en pratique. Son indispensabilité discrète est sa principale protection — et sa principale vulnérabilité.

responsabilites: >
  Gestion des flux de marchandises, données biométriques et documents d'accès entre enclaves fortifiées et zones périphériques exclues. Arbitrage des asymétries réglementaires entre secteurs du Pacte Atlantique, maintien de circuits parallèles de distribution que les autorités de la forteresse utilisent officieusement pour alimenter leurs propres économies souterraines. Négociation permanente, souvent implicite, de sa marge d'opération avec les agences de sécurité intérieure qui ferment les yeux en échange d'informations ou de services ponctuels.
...
signes_distinctifs: >
  Aucun logo, aucun siège déclaré — les opérateurs se reconnaissent à un code de coloration sur les brassards de manutentionnaire portuaire et à des marquages phosphorescents discrets sur les portes de certains entrepôts de la zone franche de Casablanca-Ouest. Les documents falsifiés du Bureau portent une micro-signature holographique invisible à l'œil nu mais lisible par les scanners des propres agents corrompus de la forteresse — preuve d'une complicité systémique assumée.
