---
name: Valparaíso FCT — Facilitation & Compensation Transfrontalière
type: instance
...
role_dans_scenario: >
  Héritière directe du port franc historique de Valparaíso, la FCT s'est reconvertie au fil des décennies en architecture invisible de la finance interbloc : elle n'émet pas de monnaie, ne produit pas de marchandises, mais traduit, compense et certifie les flux entre économies qui ne partagent plus aucun standard commun. Dans un monde où le BEC, les fonds souverains pacifiques et les blocs africains opèrent dans des cadres réglementaires et monétaires incompatibles, la FCT est le seul tiers que tout le monde accepte sans mandater officiellement. Sa neutralité n'est pas idéologique — c'est une infrastructure de survie commerciale, entretenue avec une discipline quasi-liturgique.

responsabilites: >
  La FCT opère des chambres de compensation multidevises pour les échanges informels entre blocs régionaux, fournit des protocoles de médiation contractuelle reconnus hors des cadres juridiques officiels, et certifie les flux de ressources critiques (terres rares, hydrogène, données énergétiques) lorsque les mécanismes interétatiques sont bloqués. Elle tient à jour un registre privé des équivalences tarifaires et des marges de tolérance réglementaires entre systèmes incompatibles.
...
signes_distinctifs: >
  Logo minimaliste — une balance stylisée à trois plateaux, rappelant que le tiers existe toujours — imprimé sur du papier thermique neutre sans en-tête national. Les bureaux physiques sont délibérément sobres, ni drapeaux ni symboles politiques ; seul un planisphère mural aux frontières volontairement floues orne la salle de médiation principale. Ses contrats sont rédigés en 'langage FCT', un argot juridico-financier hybride que ses propres formateurs enseignent dans des séminaires fermés.
