---
name: Bloc Eurasien Central (BEC)
type: instance
...
role_dans_scenario: >
  Bloc géopolitique instable réunissant les puissances d'Eurasie centrale dans un équilibre précaire de rivalités économiques et territoriales non résolues. Il fonctionne par compromis successifs sans vision commune, reflétant la fragmentation du système international de 2098. Son influence reste réelle mais contestée par des blocs plus cohésifs. Le BEC constitue une chambre de compensation entre des États membres qui refusent toute intégration substantielle tout en ne pouvant se passer mutuellement ni des corridors énergétiques, ni des accords de sécurité minimaux que le bloc garantit. Il est moins une puissance unifiée qu'un espace de gestion permanente de l'incompatibilité.

responsabilites: >
  Coordination des politiques énergétiques et des routes d'extraction entre membres sans harmonisation fiscale ni souveraineté partagée. Arbitrage des différends territoriaux internes via des commissions tournantes aux mandats limités. Négociation collective des accords commerciaux avec les blocs extérieurs, bien que chaque État membre conserve le droit de signer des accords parallèles bilatéraux.
...
signes_distinctifs: >
  Logo institutionnel en huit langues superposées illisibles, emblème d'une intégration avortée. Sièges tournants sans capitale fixe, incarnation d'une souveraineté partagée que personne ne veut vraiment céder. Les délégations nationales y arrivent avec leurs propres drapeaux en taille égale au logo commun — protocole significatif.
