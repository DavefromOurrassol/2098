---
name: Bureau des Zones Non Prioritaires (BZNP)
type: instance
...
role_dans_scenario: >
  Organe institutionnel maintenu dans un état de sous-financement chronique, officiellement mandaté pour coordonner l'aide aux zones périphériques ignorées par les grandes puissances. En pratique, il produit des rapports que personne ne lit et sert de caution humanitaire à un système indifférent. Sa survie même est symptomatique de la fragmentation du monde en 2098. Le BZNP est l'alibi structurel du système multilatéral : son existence permet aux blocs dominants de cocher la case 'prise en charge des marges' sans jamais engager les ressources qui rendraient cette prise en charge réelle. Il est précisément maintenu vivant parce qu'il ne fonctionne pas.

responsabilites: >
  Produit des rapports périodiques sur les zones périphériques non intégrées aux circuits énergétiques, alimentaires et informationnels dominants ; coordonne nominalement des transferts d'aide entre agences multilatérales sans budget d'exécution suffisant ; sert d'interlocuteur protocolaire pour les administrations locales des marges lorsqu'elles cherchent à signaler des crises que le système ne traitera pas.
...
signes_distinctifs: >
  Logo épuré représentant une carte mondiale dont les zones périphériques sont figurées en pointillés — une esthétique qui, remarquent ses propres agents avec amertume, matérialise involontairement leur statut d'incomplétude. Les documents officiels du BZNP sont systématiquement imprimés sur papier certifié recyclé à en-tête bilingue, dans des langues que leurs destinataires principaux ne parlent pas.
