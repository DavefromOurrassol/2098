---
name: Marges Persistantes — Zones Grises du Système Mondial
type: instance
...
role_dans_scenario: >
  Les Zones Grises constituent les marges structurelles du monde fragmenté de 2098 : espaces territoriaux que ni les blocs régionaux ni les États résiduels n'ont pleinement absorbés, mais que personne n'a non plus délibérément abandonnés. Elles fonctionnent comme des soupapes systémiques — absorbant les flux migratoires contraints, les économies parallèles, les milices locales et les tensions non résolues que les centres ordonnés ne peuvent contenir sans se déstabiliser. Dans un monde maintenu en équilibre fragile par des ajustements continus, ces zones sont le négatif nécessaire de l'ordre : leur persistance n'est pas un échec accidentel de la gouvernance mais une condition produite et implicitement tolérée par le système lui-même.

responsabilites: >
  Absorbent les populations déplacées par les crises climatiques, énergétiques et économiques que les blocs régionaux refusent d'intégrer. Hébergent les circuits logistiques et économiques parallèles — extraction informelle de ressources critiques, trafics de données non régulées, contrebande énergétique — qui alimentent en réalité les économies formelles voisines. Servent de terrain d'opération aux milices locales, aux agences de sécurité régionales mandatées et aux opérateurs privés qui se disputent les droits de passage et d'extraction.
...
signes_distinctifs: >
  Territoires visuellement reconnaissables à leur stratification : constructions modulaires récupérées, infrastructures énergétiques bricolées à partir de panneaux photovoltaïques détournés, antennes relais improvisées pour capter les réseaux des mégapoles voisines. Les milices y arborent des insignes territoriaux sans affiliation étatique — souvent des couleurs locales sur fond neutre. Les marchés informels y fonctionnent en cryptomonnaies régionales non reconnues, et les passages vers les zones régulées sont matérialisés par des checkpoints mixtes mêlant agents privés et locaux.
