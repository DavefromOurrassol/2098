...
role_dans_scenario: >
  L'AMSC opère comme une instance de coordination technocratique internationale dont l'autorité est reconnue mais constamment négociée. Dans un monde en équilibre fragile, elle joue un rôle de régulateur de dernier recours pour les interventions géo-ingénieristes — gestion des aérosols stratosphériques, coordination des barrages thermiques côtiers, attribution des corridors de migration climatique. Elle n'est ni omnipotente ni illégitime : elle survit par compromis permanents entre blocs régionaux qui lui délèguent ce qu'ils ne peuvent gérer seuls, tout en résistant à toute cession de souveraineté durable.

responsabilites: >
  Coordonne les programmes d'injection stratosphérique de soufre entre consortiums nationaux et supervise les couloirs de migration climatique certifiés. Alloue les quotas d'énergie géo-ingénieriste aux États signataires via un système de points carbone révisé annuellement. Publie les Rapports d'Urgence Climatique Opposable (RUCO), les seuls documents internationaux ayant force contraignante partielle sur les États membres.
...
signes_distinctifs: >
  Logo en forme de méridien brisé et reformé sur fond bleu glaciaire, présent sur tous les véhicules d'inspection géo-ingénieriste et les bornes des couloirs migratoires certifiés. Ses agents de terrain portent des combinaisons beige-ocre avec bandes réfléchissantes thermiques — surnommées 'sabliers' par les populations déplacées. Ses documents officiels sont systématiquement imprimés en quadrilingue avec hologramme de validation quantique.
