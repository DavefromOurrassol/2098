---
name: Union Africaine Résilience (UAR)
type: instance
...
role_dans_scenario: >
  Héritière directe de l'Union Africaine historique, l'UAR tente en 2098 de coordonner les réponses continentales aux crises climatiques, migratoires et sécuritaires dans un monde où les blocs rivaux fragmentent les loyautés de ses membres. Elle reste un interlocuteur reconnu sur la scène internationale — impossible à ignorer, difficile à mobiliser — oscillant entre la légitimité symbolique d'un continent de 4 milliards d'âmes et l'impuissance structurelle d'une institution que ses propres membres court-circuitent dès que leurs intérêts immédiats l'exigent. Elle est le lieu où se négocie, sans cesse renégocier, la question de savoir ce que signifie parler au nom de l'Afrique — en 2098 comme en 2005.

responsabilites: >
  L'UAR coordonne formellement les politiques d'adaptation climatique continentale via sa Commission Hydrique, gère les flux migratoires intra-africains liés aux déplacements environnementaux, et tente de maintenir un cadre de sécurité collective face aux zones grises sahéliennes et côtières. Elle négocie au nom du continent dans les forums multilatéraux sur les ressources critiques et l'énergie, tout en administrant un fonds de résilience territoriale dont l'alimentation reste chroniquement insuffisante.
...
signes_distinctifs: >
  Le logo de l'UAR — le contour doré du continent sur fond vert olive — orne les couloirs d'un siège d'Addis-Abeba hybridé de capteurs climatiques et d'écrans de données migratoires en temps réel. Ses représentants portent des caravanes de badges de délégation aux couleurs changeantes selon les présidences tournantes, symbole d'une institution qui ne sait pas se choisir un visage durable.
