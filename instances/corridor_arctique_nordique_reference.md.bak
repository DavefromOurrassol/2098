...
signes_distinctifs: >
  Balises lumineuses orange et blanches alternées marquant les zones de juridiction disputées, visibles à des kilomètres dans la brume arctique. Présence simultanée de pavillons d'État nordiques, de logos de consortiums privés sur les infrastructures flottantes, et de marquages en cyrillique sur les bouées sibériennes — une cacophonie visuelle qui traduit l'absence de souveraineté unique. Les cartes officielles du passage comportent systématiquement des zones hachurées labelisées 'juridiction en cours d'arbitrage'.
