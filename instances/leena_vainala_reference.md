...
signes_distinctifs: >
  Toujours associée à des documents manuscrits numérisés — une pratique délibérée pour signaler la tracabilité humaine de ses écrits dans un flux algorithmique. Palette visuelle sobre, bleu-gris nordique, interfaces dépouillées sans gamification. Sa signature numérique intègre un horodatage délibératif indiquant le temps de consultation collective ayant précédé chaque publication.
