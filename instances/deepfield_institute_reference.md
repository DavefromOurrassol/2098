---
name: Deepfield Institute for Human Continuity (DIHC)
type: instance
slug: deepfield_institute_reference
...
role_dans_scenario: >
  Institution long-termiste installée dans les États-Unis post-2055, le DIHC subordonne toute décision présente à la survie de l'espèce dans un futur lointain. Financé par des fortunes des zones post-démocratiques, il agit comme un gardien technocratique, légitimant ses programmes spatiaux privés, sa natalité sélective et sa sélection génétique par une expertise scientifique présentée comme neutre. Son influence s'étend bien au-delà des Amériques Multipolaires, modelant les politiques démographiques et biotechnologiques de plusieurs blocs souverains sous couvert de rationalité systémique.

responsabilites: >
  Le DIHC gère des programmes de préservation génétique humaine, des colonies spatiales autonomes en orbite terrestre, et des algorithmes de sélection reproductive ciblant les traits jugés 'résilients'. Il supervise également des centres de cryoconservation et des banques de données biométriques, tout en conseillant les gouvernements sur les politiques de longévité et de contrôle démographique. Ses rapports annuels sur les 'seuils critiques de viabilité civilisationnelle' servent de référence pour les législations restrictives en matière de libertés individuelles.
...
injection:
  ...
  contexte_injection: >
    Le DIHC agit comme un pivot systémique en redéfinissant les normes de gouvernance et de santé publique à l'échelle globale, au détriment des libertés individuelles et des équilibres démographiques traditionnels. Son influence sur la biotechnologie accélère les innovations, mais ses politiques restrictives en matière de démographie et de gouvernance créent des tensions structurelles durables.
...
signes_distinctifs: >
  Le logo du DIHC, un cercle fractal représentant l'expansion infinie de l'humanité, est apposé sur tous ses documents officiels. Ses employés portent des badges biométriques et des uniformes gris anthracite, tandis que ses centres de recherche sont signalés par des panneaux discrets en métal brossé. Les médias sous contrôle des consortiums privés diffusent régulièrement des documentaires glorifiant ses 'gardiens de l'humanité', souvent filmés dans des décors futuristes évoquant des colonies spatiales.
...
# Deepfield Institute for Human Continuity (DIHC)
