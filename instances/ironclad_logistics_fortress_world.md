---
name: Ironclad Sovereign Corridors (ISC)
type: instance
...
role_dans_scenario: >
  Ironclad Sovereign Corridors (ISC) est une entité hybride, à la fois entreprise logistique et quasi-État, qui contrôle les derniers corridors d'approvisionnement inter-blocs dans un monde fragmenté. Elle opère comme un réseau de convois blindés, escortés par des milices privées et des accords souverains, négociant directement avec les blocs fermés pour sécuriser des droits de passage exclusifs. Son rôle est à la fois vital et controversé : elle maintient une forme de fluidité dans un système conçu pour l'autarcie, tout en devenant un acteur géopolitique à part entière, capable de dicter ses conditions aux États forteresses.

responsabilites: >
  ISC gère les corridors logistiques critiques entre les blocs souverains, transportant des ressources stratégiques (énergie, minerais, biotech) sous des protocoles de traçabilité opaques. Elle négocie des exemptions fiscales et des droits de passage exclusifs avec les administrations frontalières, tout en assurant la protection de ses convois via des milices privées et des accords avec les agences de sécurité intérieure. Ses infrastructures (terminaux, dépôts, routes sécurisées) deviennent des zones de souveraineté de facto, échappant partiellement au contrôle des États.
...
signes_distinctifs: >
  Les convois ISC sont reconnaissables à leurs véhicules blindés noirs et gris, marqués d'un logo en forme de chaîne brisée (symbolisant à la fois la fluidité et le contrôle). Les milices d'escorte portent des uniformes modulaires aux couleurs variables selon les accords locaux, mais toujours équipés de systèmes de brouillage et de drones de surveillance. Les terminaux logistiques d'ISC, souvent situés aux frontières des blocs, ressemblent à des forteresses miniatures, avec des murs d'enceinte électrifiés et des tours de contrôle équipées de systèmes de défense active.
