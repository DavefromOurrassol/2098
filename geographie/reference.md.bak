...
zones:
  ...
  - slug: bloc_persique_autonome
    ...
    parent: null
    statut: fragmenté
    description: Coalition d'États chiites et de territoires autonomes centrée sur les ressources pétrolières
      et gazières du Golfe Persique. Contrôlée par des milices et des régimes autoritaires survivants.
    tensions_internes: Conflits internes entre factions religieuses et ethniques, pression des puissances
      régionales.
    periode_transition: 2035-2080
    evenement_transition: Révolution énergétique du Golfe 2040 et fragmentation de l'Arabie saoudite.
    lieux_emblematiques:
  ...
  - slug: ecosse_nordique_independante
    ...
    parent: null
    statut: emergent
    description: République écossaise autonome centrée sur les énergies marines renouvelables et les technologies
      vertes, intégrée aux réseaux arctiques nordiques.
    tensions_internes: Tensions entre indépendantistes et unionistes, rivalités économiques avec le reste
      du Royaume-Uni.
    periode_transition: 2040-2085
    evenement_transition: Indépendance progressive après référendum de 2042 et crise constitutionnelle britannique.
    lieux_emblematiques:
  ...
  - slug: europe_occidentale_reconstructee
    ...
    description: 'Zone européenne occidentale où persistent des institutions hybrides : Bruxelles-Nouveau
      accueille le siège du Consortium Helios (énergie solaire terrestre à grande échelle), Genève reste
      le siège de l''AMSC et du Conseil de Genève pour les droits biosociaux. Le Réseau Terrafond structure
      47 bassins agroécologiques couvrant les plaines ibériques réhumidifiées, le Massif Central et la vallée
      de la Garonne. Lyon-Métropole apparaît comme ville ordinaire sujette à la réglementation sur les technologies
      sensibles.'
    statut: stable
  ...
  - slug: iberie_atlantique_fragmentee
    ...
    - entite: Portugal
      type_entite: pays
      portion: null
    description: Zone centrée sur Lisbonne, devenue un hub logistique et financier secondaire pour les flux
      atlantiques, en concurrence avec les ports nord-européens du Corridor Arctique Nordique. Le reste
      du territoire portugais, marqué par le déclin démographique et économique, sert de périphérie agricole
      et touristique low-cost pour les élites urbaines ibériques et européennes.
    statut: fragmenté
    tensions_internes: Conflits récurrents entre les autorités lisboètes, favorables à une intégration renforcée
      avec l'Europe Occidentale Reconstruée, et les régions intérieures, où des mouvements autonomistes
      ou écologistes radicaux contestent la domination des mégapoles.
    periode_transition: 2040-2060
    evenement_transition: null
    lieux_emblematiques:
    - nom: Lisbonne (Hub Atlantique Sud)
      notes: Pôle financier et portuaire secondaire, spécialisé dans le transbordement de marchandises vers
        l'Afrique et l'Amérique latine.
      type: ville
    - nom: Alentejo (Périphérie Agro-industrielle)
      notes: Région rurale en déclin, reconvertie en zone de production agricole intensive pour les marchés
        urbains ibériques et européens.
      type: region
    - nom: Porto (Ville Satellite Déclinante)
      notes: Ancienne métropole industrielle, désormais en perte de vitesse face à Lisbonne, mais conservant
        un rôle culturel et logistique secondaire.
      type: ville
    relations:
      allies:
  ...
  - slug: israel_mediterranee_orientale
    ...
    parent: null
    statut: fragmenté
    description: État-forteresse technologique et militaire en Méditerranée orientale, entouré de zones
      instables. Centre de recherche en cybersécurité et énergies renouvelables, mais isolé diplomatiquement.
    tensions_internes: Conflits frontaliers avec le Liban et la Syrie, tensions internes entre factions
  ...
  - slug: maurice_insulaire_autonome
    ...
    parent: null
    statut: stable
    description: Île autonome spécialisée dans les services financiers offshore et les technologies vertes,
      intégrée aux réseaux Indo-Pacifiques. Centre de recherche en adaptation climatique pour les petits
      États insulaires.
    tensions_internes: Pression démographique et montée des inégalités sociales malgré la prospérité économique.
  ...
  - slug: pays_de_galles_atlantique
    ...
    parent: null
    statut: emergent
    description: République galloise autonome axée sur les énergies renouvelables offshore et les industries
      culturelles, intégrée aux réseaux atlantiques.
    tensions_internes: Débats sur l'autonomie linguistique et économique, tensions avec l'Angleterre.
    periode_transition: 2040-2085
    evenement_transition: Indépendance progressive après référendum de 2043 et crise constitutionnelle britannique.
    lieux_emblematiques:
  ...
  - slug: polynesie_francaise_insulaire
    ...
    parent: null
    statut: emergent
    description: Archipel insulaire autonome centré sur les énergies marines renouvelables et les technologies
      vertes, intégré aux réseaux économiques du Pacifique Sud. Maintient des liens culturels et politiques
      avec la France tout en développant une gouvernance locale renforcée.
    tensions_internes: Tensions entre autonomie locale et dépendance économique vis-à-vis de la métropole
      française.
  ...
  - slug: turquie_eurasie_moyen_orient
    ...
    parent: null
    statut: stable
    description: République technocratique et militarisée, contrôlant les détroits stratégiques et les corridors
      énergétiques entre l'Europe et l'Asie. Centre de transit pour les flux de données et d'énergie.
    tensions_internes: Conflits internes entre factions laïques et islamistes, pression des puissances régionales.
  ...
  - slug: istanbul
    ...
    - entite: Istanbul
      type_entite: autre
      portion: null
    description: Ancienne métropole transcontinentale devenue l'un des épicentres de la diplomatie post-institutionnelle
      en 2098, Istanbul incarne la résilience des mégapoles face à l'effondrement des États-nations. Siège
      itinérant du *Gelecek Meclisi*, elle est un laboratoire de gouvernance hybride, où se négocient des
      accords sectoriels entre consortiums technologiques, mouvements sociaux et territoires autonomes.
      Son statut de ville-pont entre Europe et Asie en fait un symbole de la fragmentation géopolitique,
      mais aussi un hub stratégique pour les scénarios de résilience climatique et économique.
    statut: emergent
    tensions_internes: Les inégalités criantes entre les quartiers ultra-connectés des consortiums (comme
      Levent ou Maslak) et les zones informelles en périphérie alimentent des tensions sociales. Les mouvements
      autonomistes locaux contestent par ailleurs l'influence croissante des plateformes d'IA dans la gestion
      urbaine, perçue comme une dépossession de la souveraineté citoyenne.
    periode_transition: 2040-2060
    evenement_transition: null
    lieux_emblematiques:
    - nom: Gelecek Kulesi (Tour du Futur)
      type: infrastructure
      notes: Ancien complexe financier reconverti en espace de négociation pour le *Gelecek Meclisi*, équipé
        de systèmes de traduction neuronale et de modélisation climatique en temps réel. Symbole de la diplomatie
        algorithmique.
    - nom: Bosphore-2
      type: infrastructure
      notes: Pont flottant et tunnel sous-marin reliant les deux rives du détroit, financé par un consortium
        sino-européen. Il abrite des fermes verticales et des centres de données sous-marins, illustrant
        la fusion entre infrastructure critique et adaptation climatique.
    - nom: Sultanahmet Résiliente
      type: site_strategique
      notes: Zone historique transformée en quartier autonome, mêlant technologies de désalinisation, énergies
        renouvelables et réseaux de solidarité locale. Modèle controversé de résilience low-tech face aux
        mégaprojets des consortiums.
    relations:
      allies:
